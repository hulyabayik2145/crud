...
//form gonderildiğinde addItem fonksiyonunu çağır
form.addEventListener("submit", addItem);

//temizleme düğmesi tıklandığında clearItems fonksşyonunu çağır

clearBtn.addEventListener("click", clearItems);
//sayfa üklendiğinde setupItems fonksiyonunu çağır
...
function addItem(e){
    ...
    const value = grocery.value; //inputun değerini al
    ...
    if(value !== "" && !editFlag){
        ...
        displayAlert("boş geçilemez!","danger");
    }
...
const element = e.currentTarget.parentElement.parentElement; //sileceğimiz  satırın kapsayıcısına ulaşma için
//console.log(element);
...
//yerel depodan kaldırma fonksiyonu
...
function editItem(e){
   ...
   //formdaki değiştirilmek istenen içeriği imputa atar
